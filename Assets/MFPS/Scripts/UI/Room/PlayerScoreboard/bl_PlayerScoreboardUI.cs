...
{
    public static bl_PlayerScoreboardUI Instance { set; get; }
    ...
    private void UpdatePlayerUI(Player player)
    {
       ...
       // PlayfabManager.Instance.SendLeaderboard(player.GetPlayerScore());

        // PlayfabManager.Instance.SendLeaderboard(player.GetPlayerScore().ToString());
